...
public class DriverExamForm extends JFrame {
	...
	public DriverExamForm() {
		setTitle("jburich ex3i Driver Exam");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 277, 321);
		...
		lblResults.setBounds(123, 19, 56, 16);
		contentPane.add(lblResults);
		
		JLabel lblResponses = new JLabel("Responses:");
		lblResponses.setBounds(25, 19, 88, 16);
		...
		responsesList.setBounds(50, 44, 36, 194);
		...
		btnPass.setBounds(125, 81, 122, 25);
		...
		questNumLabel.setBounds(15, 250, 36, 16);
		...
		inputAnswerTextField.setBounds(48, 247, 36, 22);
		...
		btnPrev.setBounds(109, 243, 70, 25);
		...
		btnNext.setBounds(181, 243, 70, 25);
